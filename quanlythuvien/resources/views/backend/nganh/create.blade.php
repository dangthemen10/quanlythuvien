...
<form name="frmCreateNganh" id="frmCreateNganh" method="post" action="{{ route('backend.nganh.store') }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <a class="btn btn-primary" href="{{ route('backend.nganh.index') }}" class="btn">Quay về</a>
