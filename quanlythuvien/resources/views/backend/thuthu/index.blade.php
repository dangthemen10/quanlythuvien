...
@endsection
@section('content')
<a href="{{ route('backend.thuthu.create') }}" class="btn btn-primary">Thêm mới</a>
<a href="{{ route('backend.thuthu.print') }}" class="btn btn-success">In Danh Sách</a>
<table class="table table-bordered table-hover table-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form name="frmDeleteThuthu" id="frmDeleteThuthu" method="post" action="{{ route('backend.thuthu.destroy', ['id' => $thuthu->id]) }}">
                    {{ csrf_field() }}
