...
@endsection
@section('content')
<a class="btn btn-primary" href="{{ route('backend.theloai.create') }}" >Thêm Mới</a>
<a href="{{ route('backend.theloai.print') }}" class="btn btn-success">In danh sách</a>
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form name="frmDeleteTheloai" id="frmDeleteTheloai" method="post" action="{{ route('backend.theloai.destroy', ['id' => $theloai->id]) }}">
                    {{ csrf_field() }}
